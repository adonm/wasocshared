...
- [Advisories (TLP:CLEAR)](advisories/)
...
{{% admonition type="abstract" title="Baselines" open=true %}}
...
{{% /admonition %}}
{{% admonition type="danger" title="Critical Infrastructure Entities and Operational Technology" open=true %}}
...
{{% /admonition %}}
{{% admonition type="tip" title="Guidelines" open=true %}}
...
{{% admonition type="note" title="Technical Documentation" open=true %}}
...
{{% /admonition %}}
{{% include-page path="threat-activity.md" %}}
