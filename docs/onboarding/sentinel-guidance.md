...
{{% admonition type="note" title="Transition your Microsoft Sentinel experience from the Azure portal to the Defender portal" open=true %}}
...
{{% admonition type="note" title="Simplify telemetry collection" open=true %}}
...
{{% /admonition %}}
{{% admonition type="note" title="Data Retention and Cost Optimization" open=true %}}
...
{{% admonition type="note" title="Log Analytics Auxiliary plan (preview)" open=true %}}
