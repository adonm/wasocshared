...
{{% admonition type="note" title="Participants Prerequisite" open=false %}}
...
The WASOC has developed guidance to assist WA Government entities to integrate the Honey Trap platform into their existing Sentinel Workspaces. This can be found at the [Github pages](https://wagov.github.io/wasoc-honeytraps/) or at our [Github repository](https://github.com/wagov/wasoc-honeytraps) for Honey Traps.
